  ...
  variants: {
    variant: {
      ...
      success: {
        ...
        circle: "stroke-green-1 dark:stroke-green-1",
      },
    },
  },
  defaultVariants: {
...
const ProgressCircle = React.forwardRef<SVGSVGElement, ProgressCircleProps>(
  (
    ...
    const circumference = normalizedRadius * Math.PI // Half of the full circle's circumference
          ...
          >
            ...
            {safeValue >= 0 ? (
              <path
                ...
                strokeLinecap="round"
                className={cn(
                  "transition-colors ease-linear rounded-full",
                  circle(),
                  showAnimation &&

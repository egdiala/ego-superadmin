...
export const TopCommuters: React.FC<TopCommutersDashboardProps> = ({ className, data, filters, setFilters }) => {
    ...
    return (
        <div className={cn("flex flex-col gap-4 p-4 rounded-lg bg-white", className)}>
            ...
            <RenderIf condition={data === undefined}>
                <div className="flex w-full h-60 items-center justify-center"><Loader className="spinner size-6 text-green-1" /></div>
            </RenderIf>
        </div>
    )
}
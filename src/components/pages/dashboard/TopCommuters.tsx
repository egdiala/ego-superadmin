            ...
            <div className="grid gap-6">
                {
                    ...
                    <div key={id} className="flex items-center justify-between">
                        <div className="flex items-center gap-1">
                            ...
                            <img src={commuter.photo} alt={commuter.name} className="object-cover object-center size-7 rounded-full" />
                            <span className="text-sm text-grey-dark-2">{commuter.name}</span>
                        </div>

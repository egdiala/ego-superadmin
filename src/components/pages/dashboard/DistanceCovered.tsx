        ...
        <div className={cn("flex flex-col h-fit gap-6 p-4 rounded-lg bg-white", className)}>
            ...
            <div className="grid gap-1">
                ...
                <div className="relative flex-1 h-fit rounded-lg bg-green-4 px-3 py-4">
                    ...
                    <motion.div className="absolute inset-0 rounded-l-lg px-0 py-4 overflow-hidden" initial={{ width: 0 }} whileInView={{ width: "0.0%" }} transition={{ ease: "linear", duration: 0.8 }} style={{ background: "linear-gradient(90.01deg, #136207 0.01%, #55B648 106.72%)"}}>

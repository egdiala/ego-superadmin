...
import { TotalTripsFilter } from "./TotalTripsFilter";
...
export const TotalTrips: React.FC<TotalTripsHomeProps> = ({ className, tripData, isLoading, filters, setFilters }) => {
    const data = useMemo(() => {
    ...
    return (
        <div className={cn("flex flex-col p-6 gap-10 rounded-lg bg-white", className)}>

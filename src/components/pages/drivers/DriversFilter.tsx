...
export const DriversFilter: React.FC<DriversFilterProps> = ({ isLoading, setFilters }) => {
    ...
    return (
        <Popover className="relative">
            ...
            >
                {({ close }) => (
                    <Fragment>
                        <h1 className="font-bold text-xl text-grey-dark-1">Driver Filter</h1>
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-5 md:gap-8">
                            ...
                            <div className="flex flex-col gap-1">
                                <span className="uppercase text-grey-dark-3 text-xs">driver status</span>

...
export const RevenueSplitEHailingPage: React.FC = () => {
    ...
    const { data: eHailingRevenue, isFetching } = useGetFees<FetchedRevenueSplit[]>({ screen_name: "e_hailing_revenue_split", component })
    ...
    return (
        <motion.div variants={pageVariants} initial='initial' animate='final' exit={pageVariants.initial} className="flex flex-col gap-4">
            ...
            <RenderFeature module="SETUP_REV_SPLIT" permission="create">
                <AddNewParameter isOpen={toggleModals.openAddNewParameterModal} close={toggleNewParameter} msg="e-Hailing revenue split created successfully!" screenName="e_hailing_revenue_split" />
            </RenderFeature>
            <RenderFeature module="SETUP_REV_SPLIT" permission="update">

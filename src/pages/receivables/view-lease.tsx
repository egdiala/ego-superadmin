...
export const ViewLeaseReceivablesPage: React.FC = () => {
    ...
    const { data: count, isFetching: fetchingReceivablesCount } = useGetLeasePayments<FetchedReceivableCount>({ request_type: "2", status: "0", start_date: id, component: "count" })
    const { data: receivables, isFetching: fetchingReceivables } = useGetLeasePayments<SingleLeaseReceivable[]>({ page: page.toString(), item_per_page: itemsPerPage.toString(), request_type: "2", status: "0", start_date: id })

...
export const ViewStaffCommuteReceivablesPage: React.FC = () => {
    ...
    const { data: count, isFetching: fetchingReceivablesCount } = useGetCommutePayments<FetchedReceivableCount>({ request_type: "2", status: "0", start_date: id, component: "count" })
    const { data: receivables, isFetching: fetchingReceivables } = useGetCommutePayments<SingleLeaseReceivable[]>({ page: page.toString(), item_per_page: itemsPerPage.toString(), request_type: "2", status: "0", start_date: id })
